...
class ScheduleEditorView extends StatelessWidget {
  ...
  List<LineChartBarData> buildLineDatas(ScheduleEditorViewModel vm) {
    ...
    for (int channelIndex = 0;
      ...
      // Skip empty channel
      final channelColor =
          HexColor.fromHex(vm.deviceInfo.channels[channelIndex].color);
      series.add(
        LineChartBarData(
          isCurved: false,
          barWidth: 2,
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
        value: context.read<LyfiViewModel>().currentEditor!
                  ...
                  builder: (context, vm, child) => Padding(
                    ...
                    child: LineChart(
                      ...
                      LineChartData(
                        ...
                        // minX: 0,
                        // maxX: 24 * 3600,
                        minX: vm.entries.isNotEmpty
                            ? vm.entries.first.instant.inHours.toDouble() *
                                3600.0
                            : 0.0,
                        maxX: vm.entries.isNotEmpty
                            ? (vm.entries.last.instant.inSeconds.toDouble() /
                                        3600.0)
                                    .ceilToDouble() *
                                3600
                            : 24 * 3600,
                        ...
                        extraLinesData: vm.currentEntry == null
                            ? null
                            : ExtraLinesData(
                                extraLinesOnTop: false,
                                verticalLines: [
                                  VerticalLine(
                                    x: vm.currentEntry!.instant.inSeconds
                                        .toDouble(),
                ...
                child: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        color: Theme.of(context).colorScheme.onPrimaryContainer,
                        onPressed: vm.isOnline && !vm.isPreviewMode
                      ...
                      IconButton(
                        ...
                        color: Theme.of(context).colorScheme.onPrimaryContainer,
                        onPressed: vm.canRemoveCurrentInstant
