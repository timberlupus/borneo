      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            const Spacer(),
            Consumer<LyfiViewModel>(
              builder: (context, vm, child) => HeroProgressIndicator(
            ...
            Selector<LyfiViewModel, double?>(
              ...
              builder: (context, fanPowerRatio, child) => HeroProgressIndicator(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: Selector<LyfiViewModel, bool>(
              ...
              builder: (context, isBusy, child) => IconButton(
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: Selector<LyfiViewModel, ({bool isBusy, bool isOnline})>(
                  selector: (_, vm) =>
                      (isBusy: vm.isBusy, isOnline: vm.isOnline),
        ...
        body: Selector<LyfiViewModel, ({bool isLocked})>(
          ...
          builder: (context, vm, _) => AnimatedSwitcher(
            duration: Duration(milliseconds: 300),
...
class LyfiScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        create: (cb) => LyfiViewModel(device.id, cb.read<DeviceManager>(),
