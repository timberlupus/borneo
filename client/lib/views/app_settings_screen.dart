...
class AppSettingsScreen extends StatelessWidget {
  ...
  List<Widget> buildItems(BuildContext context) => <Widget>[
        GenericSettingsGroup(title: context.translate('APPEARANCE'), children: [
          ListTile(
            ...
            trailing: DropdownButton<ThemeMode>(
              items: [
                DropdownMenuItem<ThemeMode>(
                    ...
                    child: Text(context.translate("System"),
                        style: Theme.of(context).textTheme.bodySmall)),
                DropdownMenuItem<ThemeMode>(
                    value: ThemeMode.light,
                    child: Text(context.translate("Light"),
                        style: Theme.of(context).textTheme.bodySmall)),
                DropdownMenuItem<ThemeMode>(
                    value: ThemeMode.dark,
                    child: Text(context.translate("Dark"),
                        style: Theme.of(context).textTheme.bodySmall)),
              ],
              onChanged: (value) {
                final vm = context.read<AppSettingsViewModel>();
        ...
        GenericSettingsGroup(title: context.translate('FEEDBACK'), children: [
          ListTile(
