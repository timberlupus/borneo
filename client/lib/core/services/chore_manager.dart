...
class IChoreManager implements IDisposable {
  final Logger? logger;
  final IClock clock;
  ...
  IChoreManager(this._globalBus, this._db, this._sceneManager, this._deviceManager, {required this.clock, this.logger})
